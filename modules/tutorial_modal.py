...
def tutorial_modal_server(input, output, session):
    ...
    def show_important_message():
        m = ui.modal(
            ...
            ui.h4("Step 1"),
            ui.output_ui("select_graph_image"),
            ui.br(),
            ...
            ui.accordion(
                ...
                ui.accordion_panel("Import from Edgelist",
                                   "This lets you create your own graph by defining an edge list.", ui.br(),
                                   ui.p(),
                ...
                ui.accordion_panel("Upload Edgelist",
                                   "This lets you upload a text file containing an edge list to import a premade graph",
                                   ui.br(),
                                   "For it to work the text file must have the same syntax as the edge list from the Import from Edgelist option."
                                   ),
            ),
            ...
            ui.br(),
            "It is expected and normal for the Algorithm to repeat steps 1 and 2 until it finds the fastest route.",
            ui.hr(),
            ui.h4("Step 4"),
            ui.output_ui("quiz_image"), ui.br(),
            "After the algorithm is done you will be asked to enter the fastest route from the Start Node to the Target Node.",
            ui.br(),
            "Only when you enter the correct answer will the Program show you the fastest path in the Graphic",
